...
SHORIF3/SHORIF.py
@Prince-150
Prince-150 Add files via upload
 1 contributor
332 lines (316 sloc)  13.4 KB
#dec by MR-META
...
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m SHORIF      \033[38;5;46m   │  \033[33;1m┗━┛
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Mr-SHORIF-404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
